\capitulocapa{images/cap-2-review.png}{Quando useState deixa de ser suficiente?}
...
\begin{center}
  \makebox[\textwidth][c]{%
    \includegraphics[width=1.16\textwidth]{images/2-1-funcionou-ate-pedido-seguinte-corrected.png}%
  }
\end{center}
...
\imagemcapitulo
  {ch02-mapa-consumidores-tema}
  {O tema passou a interessar componentes distribuídos por ramos diferentes.}
  {mapa-consumidores-tema}
