...
\imagemcapitulo
  {5-1-terceira-alteracao}
  {Múltiplas origens tornam visível o custo de coordenar o Drawer na árvore.}
  {terceira-alteracao}
...
\imagemcapitulo
  {5-2-props-context-zustand}
  {Props, Context e Zustand distribuem o mesmo tema por caminhos diferentes.}
