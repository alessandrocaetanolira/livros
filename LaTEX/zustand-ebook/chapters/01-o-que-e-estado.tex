...
\begin{center}
  \makebox[\textwidth][c]{%
    \includegraphics[width=1.16\textwidth]{images/1-1-alteracao-5-minutos.png}%
  }
\end{center}
...
\ilustracaopendente{ch01-diagrama-interface-estado}{Duas fotografias do Dashboard: antes e depois de dispensar o aviso, ligadas pela ação de clique.}
...
\ilustracaopendente{ch01-quadro-estado-derivado-constante}{Quadro de decisão comparando constante, entrada, valor derivado e estado com exemplos do WelcomeNotice.}
