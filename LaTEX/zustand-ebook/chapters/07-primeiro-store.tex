...
\imagemcapitulo
  {7-1-modal-varias-origens}
  {Três pontos do DevPanel disparam o mesmo convite por meio de uma store central.}
  {modal-varias-origens}
...
\imagemcapitulo
  {7-2-anatomia-store}
  {Contrato, estado inicial e ações formam a pequena store de convite.}
  {anatomia-store}
...
\imagemcapitulo
  {7-3-sequencia-escape}
  {Um evento externo chama a ação da store sem manipular o componente visual.}
  {sequencia-escape}
