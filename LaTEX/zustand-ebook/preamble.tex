...
% Margens espelhadas consideram leitura em páginas opostas. O bindingoffset
% reserva 5 mm adicionais junto à lombada, totalizando 23 mm no lado interno.
\usepackage[
  paperwidth=148mm,
  paperheight=210mm,
  inner=18mm,
...
% Página inteiramente branca, sem cabeçalho nem fólio.
...
% Toda abertura ocupa uma página ímpar e tem o verso completamente branco.
\newcommand{\capitulocapa}[3][0]{%
  \clearpage
  \ifodd\value{page}\else\paginabranca\fi
